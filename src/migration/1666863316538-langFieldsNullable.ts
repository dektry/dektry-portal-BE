...
export class langFieldsNullable1666863316538 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "language" ADD "pfId" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "language" ADD "code" character varying(40) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "language" DROP COLUMN "pfId"`);
        await queryRunner.query(`ALTER TABLE "language" DROP COLUMN "employee_id"`);
        await queryRunner.query(`ALTER TABLE "language" DROP COLUMN "value"`);
