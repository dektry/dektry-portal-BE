...
export class vacations1632315663769 implements MigrationInterface {
    name = 'vacations1632315663769'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "vacations" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "policy" character varying NOT NULL, "start" TIMESTAMP WITH TIME ZONE NOT NULL, "end" TIMESTAMP WITH TIME ZONE NOT NULL, "status" character varying NOT NULL, "reason" text NOT NULL, "userId" uuid, CONSTRAINT "PK_830973008a9b7e114e612442750" PRIMARY KEY ("id"))`);
