...
export class onBoardingTemplates1628522410422 implements MigrationInterface {
    name = 'onBoardingTemplates1628522410422'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "onBoarding_templates_write" ("onBoardingTemplatesId" uuid NOT NULL, "positionsId" uuid NOT NULL, CONSTRAINT "PK_1e67f6d5283d9855a5ce5493489" PRIMARY KEY ("onBoardingTemplatesId", "positionsId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_cc2733d5664df5872d7492b6d4" ON "onBoarding_templates_write" ("onBoardingTemplatesId") `);
        await queryRunner.query(`CREATE INDEX "IDX_856a614d3d7ea0ec71d1c05e6d" ON "onBoarding_templates_write" ("positionsId") `);
        await queryRunner.query(`CREATE TABLE "onBoarding_templates_read" ("onBoardingTemplatesId" uuid NOT NULL, "positionsId" uuid NOT NULL, CONSTRAINT "PK_dda7b33e45511f6e25245f75779" PRIMARY KEY ("onBoardingTemplatesId", "positionsId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_b504831eb92c7d54eded52eadb" ON "onBoarding_templates_read" ("onBoardingTemplatesId") `);
        await queryRunner.query(`CREATE INDEX "IDX_84588fd7ba5e1dd0564915dc95" ON "onBoarding_templates_read" ("positionsId") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "IDX_84588fd7ba5e1dd0564915dc95"`);
        ...
        await queryRunner.query(`DROP INDEX "IDX_856a614d3d7ea0ec71d1c05e6d"`);
