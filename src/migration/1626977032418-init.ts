...
export class init1626977032418 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "positionGroup" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(255) NOT NULL, "color" character varying(255) NOT NULL, CONSTRAINT "PK_ef2bc82fc49e4a417444b4ce077" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "projects" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(255) NOT NULL, "managers" uuid array, "users" uuid array, "isArchive" boolean, CONSTRAINT PK_projects PRIMARY KEY (id))`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_ace513fa30d485cfd25c11a9e4a" FOREIGN KEY ("role") REFERENCES "roles"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
