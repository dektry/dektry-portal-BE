...
export class init1626977032418 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "projects" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(255) NOT NULL, "managers" uuid array, "users" uuid array, CONSTRAINT projects_pkey PRIMARY KEY (id))`);
