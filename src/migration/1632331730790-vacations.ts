...
export class vacations1632331730790 implements MigrationInterface {
    name = 'vacations1632331730790'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "vacations" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "policy" character varying NOT NULL, "start" TIMESTAMP WITH TIME ZONE NOT NULL, "end" TIMESTAMP NOT NULL, "status" character varying NOT NULL, "reason" text NOT NULL, "userId" uuid, CONSTRAINT "PK_830973008a9b7e114e612442750" PRIMARY KEY ("id"))`);
