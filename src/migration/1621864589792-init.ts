...
export class init1621864589792 implements MigrationInterface {
    name = 'init1621864589792'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_14f3e7d0125a326eccaef8b207f" FOREIGN KEY ("job_position") REFERENCES "positions"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "FK_14f3e7d0125a326eccaef8b207f"`);
